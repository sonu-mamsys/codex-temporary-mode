...
export class CodexAppServer extends EventEmitter {
  ...
  async start() {
    ...
    const result = await this.request('initialize', {
      clientInfo: { name: 'ghostthread', title: 'GhostThread', version: '3.2.2' },
  ...
  handleLine(line) {
    ...
    if (message.method && Object.hasOwn(message, 'id')) {
      ...
      try { this.send({ id: message.id, error: { code: -32601, message: 'Interactive server requests are not supported by ghostthread.' } }); }
