...
function verifyManifest(root, manifest) {
  if (![2, 3, 4, 5, PATCH_VERSION].includes(manifest.version) || !Array.isArray(manifest.files) || ![2, 3, 4].includes(manifest.files.length)) throw new Error('Invalid patch manifest. No files changed.');
